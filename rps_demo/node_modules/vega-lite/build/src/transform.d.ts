...
export declare type LookupTransform = DataLookupTransform | SelectionLookupTransform;
...
export declare function isDataLookup(t: Transform): t is DataLookupTransform;
export declare function isSelectionLookup(t: Transform): t is SelectionLookupTransform;
...
export declare function normalizeTransform(transform: Transform[]): (AggregateTransform | BinTransform | CalculateTransform | DensityTransform | FlattenTransform | FoldTransform | ImputeTransform | JoinAggregateTransform | LoessTransform | DataLookupTransform | SelectionLookupTransform | QuantileTransform | RegressionTransform | TimeUnitTransform | SampleTransform | StackTransform | WindowTransform | PivotTransform | {
    filter: LogicalOperand<Predicate>;
})[];
